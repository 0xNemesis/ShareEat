       ...
       <div className="bg-blue-50 border border-blue-100 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
         <div>
           <div className="flex items-center gap-2 mb-2">
             <Badge className="bg-blue-500 hover:bg-blue-600">Volunteer Terverifikasi</Badge>
           </div>
           <h1 className="font-heading text-3xl font-bold text-blue-950">Pusat Volunteer</h1>
           <p className="text-blue-700/80 max-w-xl mt-2">
             Terima kasih telah membantu kami mendistribusikan makanan kepada mereka yang paling membutuhkan.
             Pesan jumlah besar di sini untuk distribusi.
           </p>
         </div>
         <div className="bg-white p-4 rounded-xl shadow-sm border border-blue-100 min-w-[200px]">
           <div className="text-sm text-muted-foreground mb-1">Skor Dampak</div>
           <div className="text-3xl font-heading font-bold text-blue-600">Level 3</div>
           <div className="text-xs text-blue-400 mt-1">LVL selanjutnya: 5 slot distribusi</div>
         </div>
       </div>
       ...
       <div>
         ...
         <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {volunteerSessions.length === 0 && (
              <p className="text-muted-foreground">Tidak ada kesempatan volunteer saat ini.</p>
            )}
         </div>
       </div>
    </div>
